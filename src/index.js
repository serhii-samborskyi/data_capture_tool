...
const enrichmentFieldSchema = z.object({
  ...
  qwenInputOnly: z.boolean().optional(),
  useEvidenceJsonResult: z.boolean().optional(),
  skipQwenFallback: z.boolean().optional(),
...
const settingsSchema = z.object({
  ...
  brightDataSerpMode: z.enum(["request", "dataset", "ai_mode", "browser_automation_tool"]).optional(),
  brightDataApiToken: z.string().optional(),
  browserAutomationToolBaseUrl: z.string().url().optional(),
  browserAutomationScriptName: z.string().min(1).optional(),
